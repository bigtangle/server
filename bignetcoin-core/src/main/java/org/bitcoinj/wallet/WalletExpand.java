...
public class WalletExpand extends Wallet {
 

    public WalletExpand(NetworkParameters params) {
        super(params);
    }

    private static final Logger log = LoggerFactory.getLogger(WalletExpand.class);  
