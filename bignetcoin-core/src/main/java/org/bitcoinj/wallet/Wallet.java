...
public class Wallet extends BaseTaggableObject implements KeyBag, TransactionBag {
     ...
     * {@link org.bitcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The
     ...
     * {@link #currentKey(org.bitcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.bitcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the
     * parameter.
     */
     ...
     * {@link #currentKey(org.bitcoinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling
     * {@link #currentAddress(org.bitcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.bitcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the
     * parameter.
     */
    ...
    /**
     * An alias for calling
     * {@link #freshKey(org.bitcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.bitcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the
     * parameter.
     */
    ...
    /**
     * Returns address for a
     * {@link #freshKey(org.bitcoinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling
     * {@link #freshAddress(org.bitcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.bitcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the
     * parameter.
     */
    ...
    /**
     * See
     * {@link org.bitcoinj.wallet.DeterministicKeyChain#setLookaheadSize(int)}
    ...
    /**
     * See
     * {@link org.bitcoinj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)}
     * for more info on this.
     */
     ...
     * {@link org.bitcoinj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)}
     * for more info on this.
     */
     ...
     * 
     * @throws org.bitcoinj.core.ECKey.MissingPrivateKeyException
    ...
    public boolean maybeCommitTx(Transaction tx) throws VerificationException {
        ...
        try {
            ...
            // Put any outputs that are sending money back to us into the
            // unspents map, and calculate their total value.
            ...
            if (!doubleSpendUnspentTxns.isEmpty() || !doubleSpendSpentTxns.isEmpty()
                    || !isNotSpendingTxnsInConfidenceType(tx, ConfidenceType.DEAD)) {
                // tx is a double spend against a tx already in the best chain
                // or spends outputs of a DEAD tx.
                // Add tx to the dead pool and schedule confidence listener
                // notifications.
                ...
                // of a tx already IN_CONFLICT.
                // Add tx to the pending pool. Update the confidence type of tx,
                // the txns in conflict with tx and all
                // their dependencies to IN_CONFLICT and schedule confidence
                ...
                // Add to the pending pool and schedule confidence listener
                // notifications.
            ...
            // Mark any keys used in the outputs as "used", this allows wallet
            // UI's to auto-advance the current key
     ...
     * {@link org.bitcoinj.core.ECKey#getCreationTimeSeconds()}. This can return
     ...
     * {@link org.bitcoinj.utils.Threading#waitForUserCode()} to block until the
     * future had a chance to be updated.
     * </p>
     */
