...
public class DefaultCoinSelector implements CoinSelector {
    ...
    public CoinSelection select(Coin target, List<TransactionOutput> candidates) {
      ...
      //  }
        ...
        // transaction.
        return new CoinSelection(Coin.valueOf(total, target.tokenid), selected);
    }
    ...
    public static boolean isSelectable(Transaction tx) {
        ...
        return type.equals(TransactionConfidence.ConfidenceType.BUILDING) ||
                ...
                type.equals(TransactionConfidence.ConfidenceType.PENDING)
                        ...
                        // In regtest mode we expect to have only one peer, so
                        // we won't see transactions propagate.
                        // TODO: The value 1 below dates from a time when
                        // transactions we broadcast *to* were counted, set to 0
