 ...
 *
 * <p>TransactionConfidence is updated via the {@link net.bigtangle.core.TransactionConfidence#incrementDepthInBlocks()}
 * method to ensure the block depth is up to date.</p>
 * To make a copy that won't be changed, use {@link net.bigtangle.core.TransactionConfidence#duplicate()}.
 */
public class TransactionConfidence {
     ...
     * {@link BlockChainListener}, attach it to a {@link BlockGraph} and then use the getters on the
     ...
     * and so on. This information is useful for {@link net.bigtangle.wallet.CoinSelector} implementations to risk analyze
