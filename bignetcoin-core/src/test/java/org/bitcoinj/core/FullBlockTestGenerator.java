...
public class FullBlockTestGenerator {
    ...
    public RuleList getBlocksToTest(boolean runBarelyExpensiveTests, boolean runExpensiveTests, File blockStorageFile) throws ScriptException, ProtocolException, IOException {
        ...
        Block chainHead =BlockForTest.createNextBlockWithCoinbase( params.getGenesisBlock(),Block.BLOCK_VERSION_GENESIS, coinbaseOutKeyPubKey, chainHeadHeight,params.getGenesisBlock().getHash());
        ...
        for (int i = 1; i < params.getSpendableCoinbaseDepth(); i++) {
            chainHead = BlockForTest.createNextBlockWithCoinbase(chainHead,Block.BLOCK_VERSION_GENESIS, coinbaseOutKeyPubKey, chainHeadHeight,params.getGenesisBlock().getHash());
            chainHeadHeight++;
        ...
        byte[] outScriptBytes = ScriptBuilder.createOutputScript(ECKey.fromPublicOnly(coinbaseOutKeyPubKey)).getProgram();
        {
            ...
            b44.addCoinbaseTransaction(coinbaseOutKeyPubKey, ZERO, chainHeadHeight + 15, NetworkParameters.BIGNETCOIN_TOKENID);
        ...
        {
            Transaction coinbase = new Transaction(params, NetworkParameters.BIGNETCOIN_TOKENID);
        ...
        {
            b56txToDuplicate = new Transaction(params, NetworkParameters.BIGNETCOIN_TOKENID);
        ...
        Transaction b56p2txToDuplicate1, b56p2txToDuplicate2;
        {
            ...
            b56p2txToDuplicate1 = new Transaction(params, NetworkParameters.BIGNETCOIN_TOKENID);
            ...
            b56p2txToDuplicate2 = new Transaction(params, NetworkParameters.BIGNETCOIN_TOKENID);
        ...
        NewBlock b67 = createNextBlock(b65, chainHeadHeight + 21, null, null);
        {
            ...
            Transaction tx3 = new Transaction(params, NetworkParameters.BIGNETCOIN_TOKENID);
        ...
        Transaction b78tx = new Transaction(params, NetworkParameters.BIGNETCOIN_TOKENID);
        {
        ...
        Transaction b79tx = new Transaction(params, NetworkParameters.BIGNETCOIN_TOKENID);
        ...
        Transaction b84tx1 = new Transaction(params, NetworkParameters.BIGNETCOIN_TOKENID);
        {
            ...
            Transaction tx4 = new Transaction(params, NetworkParameters.BIGNETCOIN_TOKENID);
            ...
            Transaction tx5 = new Transaction(params, NetworkParameters.BIGNETCOIN_TOKENID);
