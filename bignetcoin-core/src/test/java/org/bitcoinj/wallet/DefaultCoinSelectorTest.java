...
public class DefaultCoinSelectorTest extends TestWithWallet {
    ...
    public void depthOrdering() throws Exception {
        ...
        Transaction t1 = checkNotNull(sendMoneyToWallet(AbstractBlockTangle.NewBlockType.BEST_CHAIN, COIN));
        Transaction t2 = checkNotNull(sendMoneyToWallet(AbstractBlockTangle.NewBlockType.BEST_CHAIN, COIN));
    ...
    public void coinAgeOrdering() throws Exception {
        ...
        Transaction t2 = checkNotNull(sendMoneyToWallet(AbstractBlockTangle.NewBlockType.BEST_CHAIN, TWO_COINS));
        Transaction t3 = checkNotNull(sendMoneyToWallet(AbstractBlockTangle.NewBlockType.BEST_CHAIN, CENT));
