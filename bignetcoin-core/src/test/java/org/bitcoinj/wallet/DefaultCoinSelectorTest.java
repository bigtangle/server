...
public class DefaultCoinSelectorTest extends TestWithWallet {
    ...
    public void depthOrdering() throws Exception {
        ...
        Transaction t2 = checkNotNull(sendMoneyToWallet(AbstractBlockGraph.NewBlockType.BEST_CHAIN, COIN));
    ...
    public void coinAgeOrdering() throws Exception {
        ...
        Transaction t2 = checkNotNull(sendMoneyToWallet(AbstractBlockGraph.NewBlockType.BEST_CHAIN, TWO_COINS));
        Transaction t3 = checkNotNull(sendMoneyToWallet(AbstractBlockGraph.NewBlockType.BEST_CHAIN, CENT));
