...
public class ScriptTest {
    ...
    public void testCreateMultiSigInputScript() {
        ...
        Transaction spendTx = new Transaction(PARAMS, NetworkParameters.BIGNETCOIN_TOKENID);;
    ...
    public void dataDrivenValidScripts() throws Exception {
        ...
        for (JsonNode test : json) {
            ...
            try {
                scriptSig.correctlySpends(new Transaction(PARAMS, NetworkParameters.BIGNETCOIN_TOKENID), 0, scriptPubKey, verifyFlags);
