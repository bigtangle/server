...
public class APIIntegrationTests extends AbstractIntegrationTest {
	...
	public void testCreateToken() throws JsonProcessingException, Exception {
		...
		List<ECKey> signKeys = new LinkedList<ECKey>();
		signKeys.add(walletAppKit.wallet().walletKeys(null).get(2));
		signKeys.add(walletAppKit1.wallet().walletKeys(null).get(2));
		signKeys.add(walletAppKit2.wallet().walletKeys(null).get(2));
		TokenInfo tokenInfo = new TokenInfo();
