...
public class Wallet extends BaseTaggableObject implements KeyBag {
	 ...
	 * @param delayTime     How many time units to wait until saving the wallet on a
	 *                      background thread.
	 * @param timeUnit      the unit of measurement for delayTime.
	 * @param eventListener callback to be informed when the auto-save thread does
	 *                      things, or null
	 */
	...
	// List<UTXO> coinList may not pay the amount, the rest to be paid is restAmount
	public Block payFromListNoSplit(KeyParameter aesKey, String destination, Coin amount, Coin restAmount, String memo,
			List<UTXO> coinList)
			throws JsonProcessingException, IOException, InsufficientMoneyException, UTXOProviderException {

		restAmount = amount.negate();
