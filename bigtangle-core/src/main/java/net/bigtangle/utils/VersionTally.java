 ...
 *
 * @see net.bigtangle.core.NetworkParameters#getMajorityWindow()
 * @see net.bigtangle.core.NetworkParameters#getMajorityEnforceBlockUpgrade()
 * @see net.bigtangle.core.NetworkParameters#getMajorityRejectBlockOutdated()
 */
