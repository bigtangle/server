...
public class ContractExecution extends SpentBlock implements java.io.Serializable {
    ...
    public ContractExecution(Sha256Hash hash,String contractTokenid, boolean confirmed, boolean spent, Sha256Hash prevBlockHash,
