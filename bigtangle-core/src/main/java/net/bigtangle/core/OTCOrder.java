...
public class OTCOrder implements java.io.Serializable {

    public static OTCOrder create(String address, String tokenid, int type, Date validateto, Date validatefrom,
            long price, long amount, String market) {
        return new OTCOrder(address, tokenid, type, validateto, validatefrom, price, amount, market);
    }
    ...
    public OTCOrder(String address, String tokenid, int type, Date validateto, Date validatefrom, 
            long price, long amount, String market) {
