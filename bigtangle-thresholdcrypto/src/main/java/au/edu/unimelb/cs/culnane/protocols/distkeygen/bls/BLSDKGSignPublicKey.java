 ...
 *
 */
public class BLSDKGSignPublicKey<E extends CommunicationLayerMessage<?> & StorageObject<E>>
		implements ProtocolStep<Boolean, E> {
	/**
	 * Logger
	 */
	private static final Logger logger = LoggerFactory.getLogger(BLSDKGSignPublicKey.class);
	 ...
	 * 
	 */
	public BLSDKGSignPublicKey(String keyId) {
		this.keyId = keyId;
	...
	public Boolean call() throws Exception {
		...
		StorageObject<E> publickeyData = protocol.getFromStorage(BLSDKGCombinePublicKey.STEP_ID + ":" + keyId).get();
		...
		byte[] jointPublicKey = publickeyData.getBytes(BLSDKGCombinePublicKey.STORAGE.JOINT_PUBLIC_KEY);
