...
import strat.mining.stratum.proxy.utils.HexUtils;
...
public class ScryptHashingUtils {
	...
	public static BigInteger getBlockHeaderHash(String blockHeader) {
		...
		// bit to 0)
		BigInteger hashInteger = new BigInteger(org.apache.commons.lang3.ArrayUtils.addAll(BIG_INTEGER_FAKE_SIGN_ARRAY, hashBytes256Bits));
