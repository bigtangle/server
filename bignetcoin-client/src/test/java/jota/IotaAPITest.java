...
public class IotaAPITest {
    ...
    private static final String ROOT_SEED1 = "ZYHXIHGDJEHQZBGAIFGJ9UY9ORTLUUYYLJGMDPDVLIMHQIRICAMKIO9GRYRWZIYSWNZUGBLBMPXYX9FOY";
    private static final String ROOT_ADDRESS_WITH_CHECKSUM_SECURITY_LEVEL_1 = "QWKFUNEVIKH9Q9ZATFLRYNPIDMPWR9RYEMCHJFBEVWOWGBJBYZASEBRCZQVPGRICUHPWDXGXEQDJZDSKWCA9RKAEMW";
    ...
    public void createApiClientInstance() {
        iotaAPI = new IotaAPI.Builder().protocol("http").host("localhost").port("14265").build();
    }
    ...
    public void shouldCreateIotaApiProxyInstanceWithDefaultValues() {
        ...
        assertThat(iotaAPI.getHost(), Is.is("localhost"));
    ...
    public void shouldPrepareTransfer() throws ArgumentException {
        ...
        transfers.add(new Transfer(TEST_ADDRESS_WITH_CHECKSUM_SECURITY_LEVEL_1 , 100, TEST_MESSAGE, TEST_TAG));
        List<String> trytes = iotaAPI.prepareTransfers(ROOT_SEED1, 2, transfers, null, null, false);
    ...
    public void shouldNotSendTransfer() throws ArgumentException {
        ...
        SendTransferResponse str = iotaAPI.sendTransfer(TEST_SEED1, 2, DEPTH, MIN_WEIGHT_MAGNITUDE, transfers, null,
                null, false, true);
    ...
    public void shouldSendTransferWithoutInputs() throws ArgumentException {
        ...
        SendTransferResponse str = iotaAPI.sendTransfer(ROOT_SEED1, 2, DEPTH, MIN_WEIGHT_MAGNITUDE, transfers, null,
                null, false, false);
        assertThat(str.getTransactions(), IsNull.notNullValue());
        assertThat(str.getSuccessfully(), IsNull.notNullValue());
    }
    ...
    public void shouldSendTransferWithInputs() throws ArgumentException {
        ...
        GetBalancesAndFormatResponse rsp = iotaAPI.getInputs(ROOT_SEED1, 2, 0, 0, 1);

        inputlist.addAll(rsp.getInputs());

        transfers.add(new Transfer(TEST_ADDRESS_WITHOUT_CHECKSUM_SECURITY_LEVEL_2, 1, TEST_MESSAGE, TEST_TAG));

        SendTransferResponse str = iotaAPI.sendTransfer(ROOT_SEED1, 2, DEPTH, MIN_WEIGHT_MAGNITUDE, transfers,
                inputlist, null, true, true);
        assertThat(str.getTransactions(), IsNull.notNullValue());
        assertThat(str.getSuccessfully(), IsNull.notNullValue());
    }
}