...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * {@link net.bigtangle.store.PeerGroup#getMaxConnections()} you can wait
     ...
     * whatever {@link net.bigtangle.store.PeerGroup#getMaxConnections()}
     * returns is used.
     */
    ...
    /**
     * See {@link net.bigtangle.store.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * {@link net.bigtangle.store.TransactionBroadcast#future()} method will be
     ...
     *
     * <p>
     * The returned {@link net.bigtangle.store.TransactionBroadcast} object can
     ...
     * {@link net.bigtangle.store.Peer#getLastPingTime()} but it increases load
     ...
     * using {@link net.bigtangle.store.Peer#ping()}.
     */
