...
public class Peer extends PeerSocketHandler {
    ...
    private void invokeOnBlocksDownloaded(final Block block, @Nullable final FilteredBlock fb) {
        ...
        final long blocksLeft = Math.max(0, (long) vPeerVersionMessage.bestHeight - checkNotNull(blockChain).getMaxHeight());
...
//        }
     ...
     * Once the pong is received the value returned by {@link net.bigtangle.store.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link net.bigtangle.store.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link net.bigtangle.store.Peer#ping()} has never
