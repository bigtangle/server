...
public class FullPrunedBlockGraphTest extends AbstractIntegrationTest {
    ...
    public void testConfirmTransactionalUTXOs() throws Exception {
        ...
        // Confirm
        blockGraph.confirm(spenderBlock.getHash(), new HashSet<>(), NetworkParameters.MILESTONE_CUTOFF);
    ...
    public void testConfirmTokenUTXOs() throws Exception {
        ...
        blockGraph.confirm(block1.getHash(), new HashSet<>(), NetworkParameters.MILESTONE_CUTOFF);
    ...
    public void testConfirmOrderReclaimUTXOs() throws Exception {
        ...
        // Confirm
        milestoneService.update();
        blockGraph.confirm(block2.getHash(), new HashSet<>(), NetworkParameters.MILESTONE_CUTOFF);
    ...
    public void testConfirmOrderMatchUTXOs1() throws Exception {
        ...
        // Confirm
        blockGraph.confirm(rewardBlock1.getHash(), new HashSet<>(), NetworkParameters.MILESTONE_CUTOFF);
    ...
    public void testUnconfirmTokenUTXOs() throws Exception {
        ...
        blockGraph.confirm(block11.getHash(), new HashSet<>(), NetworkParameters.MILESTONE_CUTOFF);
    ...
    public void testUnconfirmDependentsRewardVirtualSpenders() throws Exception {
        ...
        // Confirm
        milestoneService.update();
        blockGraph.confirm(spenderBlock.getHash(), new HashSet<Sha256Hash>(), NetworkParameters.MILESTONE_CUTOFF);
    ...
    public void testUnconfirmDependentsToken() throws Exception {
        ...
        // Confirm
        blockGraph.confirm(firstIssuance, new HashSet<>(), NetworkParameters.MILESTONE_CUTOFF);
        blockGraph.confirm(subseqIssuance, new HashSet<>(), NetworkParameters.MILESTONE_CUTOFF);
    ...
    public void testUnconfirmDependentsOrderMatchingDependentReclaim() throws Exception {
        ...
        // Repeat
        blockGraph.confirm(rewardBlock.getHash(), new HashSet<>(), NetworkParameters.MILESTONE_CUTOFF);
        blockGraph.confirm(reclaimBlock.getHash(), new HashSet<>(), NetworkParameters.MILESTONE_CUTOFF);
        blockGraph.unconfirm(rewardBlock.getHash(), new HashSet<>());
        assertFalse(store.getBlockEvaluation(reclaimBlock.getHash()).isConfirmed());
    }
