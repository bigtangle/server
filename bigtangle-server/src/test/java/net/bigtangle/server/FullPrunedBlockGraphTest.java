...
public class FullPrunedBlockGraphTest extends AbstractIntegrationTest {
    ...
    public void testConfirmTransactionalUTXOs() throws Exception {
        ...
        // Confirm
        blockGraph.confirm(spenderBlock.getHash(), new HashSet<>(), (long) -1);
    ...
    public void testConfirmTokenUTXOs() throws Exception {
        ...
        blockGraph.confirm(block1.getHash(), new HashSet<>(), (long) -1);
    ...
    public void testConfirmOrderMatchUTXOs1() throws Exception {
        ...
        // Confirm
        blockGraph.confirm(rewardBlock1.getHash(), new HashSet<>(), (long) -1);
    ...
    public void testConfirmOrderMatchUTXOs2() throws Exception {
        ...
        Block block2 = null;
        {
            ...
            blockGraph.confirm(block2.getHash(), new HashSet<>(), (long) -1);
        }
    ...
    public void testUnconfirmTokenUTXOs() throws Exception {
        ...
        blockGraph.confirm(block11.getHash(), new HashSet<>(), (long) -1);
    ...
    public void testUnconfirmDependentsTransactional() throws Exception {
        ...
        blockGraph.unconfirmRecursive(block1.getHash(), new HashSet<>());
    ...
    public void testUnconfirmDependentsRewardOtherRewards() throws Exception {
        ...
        // Unconfirm
        blockGraph.unconfirmRecursive(rewardBlock11.getHash(), new HashSet<>());
    ...
    public void testUnconfirmDependentsRewardVirtualSpenders() throws Exception {
        ...
        // Confirm
        mcmcService.update();
        blockGraph.confirm(spenderBlock.getHash(), new HashSet<Sha256Hash>(), (long) -1);
        ...
        blockGraph.unconfirmRecursive(rewardBlock.getHash(), new HashSet<>());
    ...
    public void testUnconfirmDependentsToken() throws Exception {
        ...
        // Confirm
        blockGraph.confirm(firstIssuance, new HashSet<>(), (long) -1);
        blockGraph.confirm(subseqIssuance, new HashSet<>(), (long) -1);
        ...
        // Unconfirm
        blockGraph.unconfirmRecursive(firstIssuance, new HashSet<>());
