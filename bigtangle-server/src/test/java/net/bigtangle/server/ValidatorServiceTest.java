...
public class ValidatorServiceTest extends AbstractIntegrationTest {
    ...
    public void testUnsolidMissingUTXO() throws Exception {
        ...
        blockGraph.confirm(depBlock.getHash(), new HashSet<>(), (long) -1);
    ...
    public void testUnsolidMissingReward() throws Exception {
        ...
        for (Block b : blocks1) {
            ...
            blockGraph.confirm(b.getHash(), new HashSet<Sha256Hash>(), (long) -1);
        }
        ...
        blockGraph.confirm(rewardBlock2.getHash(), new HashSet<Sha256Hash>(), (long) -1);
    ...
    public void testSolidityPredecessorConsensusInheritance() throws Exception {
        ...
        for (int i = 0; i < 1
            ...
            blockGraph.confirm(rollingBlock.getHash(), new HashSet<Sha256Hash>(), (long) -1);
        }
    ...
    public void testSolidityTXDoubleSpend() throws Exception {
        ...
        // Confirm 1
        blockGraph.confirm(spenderBlock1.getHash(), new HashSet<>(), (long) -1);
        ...
        // Confirm 2
        blockGraph.confirm(spenderBlock2.getHash(), new HashSet<>(), (long) -1);
    ...
    public void testSolidityOrderOpenMultipleTXs() throws Exception {
        ...
        Block tokenBlock = null;
        {
            ...
            blockGraph.confirm(tokenBlock.getHash(), new HashSet<>(), (long) -1);
        }
