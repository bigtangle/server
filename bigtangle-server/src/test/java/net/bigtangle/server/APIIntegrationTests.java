...
public class APIIntegrationTests extends AbstractIntegrationTest {
    ...
    public void testBlockDamage() throws Exception {
        ...
        HashMap<String, Object> requestParam = new HashMap<String, Object>();
        byte[] buf = OkHttp3Util.post(contextRoot + ReqCmd.askTransaction.name(), Json.jsonmapper().writeValueAsString(requestParam));
    ...
    public void testCreateMultiSig() throws JsonProcessingException, Exception {
        ...
        TokenSerialIndexResponse tokenSerialIndexResponse = Json.jsonmapper().readValue(resp2, TokenSerialIndexResponse.class);
        Integer tokenindex_ = tokenSerialIndexResponse.getTokenindex();
