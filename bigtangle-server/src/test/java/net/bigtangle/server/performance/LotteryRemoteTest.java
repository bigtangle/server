...
//    @Test
	...
	public void buyTicket(ECKey key, ECKey accountKey) throws Exception {
		...
		try {
			...
			w.pay(null, accountKey.toAddress(networkParameters).toString(),
					Coin.valueOf(payamount, Utils.HEX.decode(USDTokenPub)), new MemoInfo(" buy ticket"));
		} catch (Exception e) {
	...
	public List<ECKey> payKeys() throws Exception {
		...
		Block b = wallet.payToList(null, giveMoneyResult, Utils.HEX.decode(USDTokenPub), " pay to user ");
