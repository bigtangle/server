...
sudo docker rm -f $SERVERHOST 

sudo docker  run -d -t --net=cc-bridged-network   --link $DBHOST  \
...
-e SERVER_MINERADDRESS=$SERVER_MINERADDRESS -e SERVICE_INITSYNC=$SERVICE_INITSYNC \
